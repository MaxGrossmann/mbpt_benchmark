...
the plane-wave cutoff and the number of k-points for a given material using PBE pseudopotentials.
...
def qe_convergence_pbe(cse, base_dir, ncores, calc_dir, db_entry_path):
    ...
    # log message
    print("Starting QE convergence with PBE pseudopotential:", flush=True)
    ...
    cse.parameters.update({"qe_conv_pbe": param_dict, "num_elec_pbe": num_elec})

    # go back to main calculation dir for material
    os.chdir("..")
